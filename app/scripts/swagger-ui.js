...
angular
	...
	.directive('swaggerUi', function() {
		...
		return {
			...
			templateUrl: 'views/templates/swagger-ui.html',
			scope: {
				url: '=',
				tryIt: '=',
				errorHandler: '=',
...
/*angular.module('swaggerUiTemplates', ['views/templates/swagger-ui.html']);

angular.module('views/templates/swagger-ui.html', []).run(['$templateCache', function($templateCache) {
  $templateCache.put('views/templates/swagger-ui.html',
